...
//                           //   var value = key + startValue.substring(0, startValue.length);
//                           //   console.log(length);
//                           // });
//                             var length = startValue.length
//                             var value = startValue.substr(0, cursor) + key + startValue.substring(cursor, startValue.length);
//                             console.log(startValue.substring(cursor, startValue.length));
...
var client = new ZeroClipboard( $("#clip"), {
  ...
  function numm (){
    ...
    //copy button------------------
    var copy = $('.haha').html().replace('руб.', '') + $('.rezultcena').html();
    //console.log(copy);
    ...
    client.on("load", function(client) {
      ...
      client.on("complete", function(client, args) {
        console.log("ok");
        $('.display__descr').html("Скопировано в буфер! -->");
